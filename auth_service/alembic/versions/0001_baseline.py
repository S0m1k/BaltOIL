...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("role", postgresql.ENUM("admin", "manager", "driver", "client", name="userrole", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("client_type", postgresql.ENUM("individual", "company", name="clienttype", create_type=False), nullable=False),
