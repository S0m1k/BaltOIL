...
class Settings(BaseSettings):
    ...
    # Окно, внутри которого повтор уже ротированного refresh-токена считается
    # штатной гонкой (две вкладки/устройства обновились одновременно), а не
    # кражей. Вне окна — прежнее поведение: отзыв всех сессий пользователя.
