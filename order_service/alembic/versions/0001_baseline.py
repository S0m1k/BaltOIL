...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("fuel_type", postgresql.ENUM("diesel_summer", "diesel_winter", "petrol_92", "petrol_95", "fuel_oil", name="fueltype", create_type=False), nullable=False),
        ...
        sa.Column("payment_type", postgresql.ENUM("invoice", "on_delivery", name="paymenttype", create_type=False), nullable=False, server_default="invoice"),
        sa.Column("status", postgresql.ENUM("new", "in_progress", "assigned", "in_transit", "delivered", "partially_delivered", "closed", "rejected", name="orderstatus", create_type=False), nullable=False, server_default="new"),
        sa.Column("priority", postgresql.ENUM("normal", "urgent", name="orderpriority", create_type=False), nullable=False, server_default="normal"),
    ...
    op.create_table(
        ...
        sa.Column("from_status", postgresql.ENUM("new", "in_progress", "assigned", "in_transit", "delivered", "partially_delivered", "closed", "rejected", name="orderstatus", create_type=False), nullable=True),
        sa.Column("to_status", postgresql.ENUM("new", "in_progress", "assigned", "in_transit", "delivered", "partially_delivered", "closed", "rejected", name="orderstatus", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("client_id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("kind", postgresql.ENUM("prepayment", "actual", "invoice", name="paymentkind", create_type=False), nullable=False),
        sa.Column("status", postgresql.ENUM("pending", "paid", "cancelled", name="paymentstatus", create_type=False), nullable=False, server_default="pending"),
        sa.Column("method", postgresql.ENUM("cash", "card", "bank_transfer", name="paymentmethod", create_type=False), nullable=True),
